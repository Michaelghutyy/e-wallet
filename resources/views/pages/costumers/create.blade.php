			...
			<div class="card">
				<div class="card-body">
					...
					<div class="d-flex justify-content-between mb-5">
						...
						<a href="{{ route('costumer.index') }}" class="btn btn-gradient-primary btn-rounded btn-fw">Kembali</a>
					</div>

					<form class="forms-sample" action="{{ route('costumer.store') }}" method="POST">
						@csrf
